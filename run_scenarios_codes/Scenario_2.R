#=========================================================#
#       Control actions disease workshop code #2          #
#=========================================================#
#Note:
...
population$I_swi_pop[population$node== 66] <- 1                                  # Infected 10 bovine in the farm id = 66
...
t2-t1
# Time difference of 4.953116 hours
#
#===========================================================================#
# plot output model --------------------------------------------------------
#===========================================================================#
# plot epidemic curve animal first 20 days (initial spread )
plot_SEIR_animals(model_2, plot_suceptible_compartment = F, by_host = F)
## plot epidemic curve animal level by host
plot_SEIR_animals(model_2, plot_suceptible_compartment = F, by_host = T)
#plot the epidemic curve considering
plot_SEIR_farms(model_2)

# here will plot the control actions
myplots  <- plot_SEIR_vacc_depop_ani(modeloutput = model_2, summary_control = banco_summary)
