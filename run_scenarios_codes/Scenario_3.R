#=========================================================#
#       Control actions disease workshop code #3          #
#=========================================================#
#Note:
...
population$I_bov_pop[population$node== 137753] <- 10                               # Infected 10 bovine in the farm id = 66
...
# load_App()
## run model in R
model_3     <- SEIR_model(population = population,                                                 #  Population database
                          events = events,                                                         #  Events database
                          simulation_name = "scenario_3",                                     #  Simulation tag name
...
population <- update_population_in_model(original_population = MHASpread::population,
                                         model_3$populationdb )                                        # Complete  and update the  population database
...
t2-t1
# Time difference of 30.11636 mins
#
#===========================================================================#
# plot output model --------------------------------------------------------
#===========================================================================#
# plot epidemic curve animal first 20 days (initial spread )
plot_SEIR_animals(model_3, plot_suceptible_compartment = F, by_host = F)
## plot epidemic curve animal level by host
plot_SEIR_animals(model_3, plot_suceptible_compartment = F, by_host = T)
#plot the epidemic curve considering
plot_SEIR_farms(model_3)

# here will plot the control actions
myplots  <- plot_SEIR_vacc_depop_ani(modeloutput = model_3, summary_control = banco_summary)
